...
- **EEPROM 초기화**: Select + Start 버튼 동시 누르면 모든 설정 초기화 및 재시작
...
- **Select + Start 버튼 동시 누르기**: 모든 EEPROM 설정 초기화 및 ESP32 재시작
...
1. ESP32 부팅
2. EEPROM에서 속도 설정 및 버튼 스왑 설정 로드
...
| **R1 버튼** | 헤드라이트 토글 | ON/OFF |
| **L1 + R1 (3초)** | 버튼 스왑 토글 | A/B, X/Y 매핑 변경 |
| **Select + Start** | EEPROM 초기화 | 재시작 |
