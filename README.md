...
| GPIO 19 | 포 마운트 서보 모터 | 포 마운트 각도 제어 (우측 Y축) |
| GPIO 21 | 터렛 모터 IN1 | DRV8833 터렛 제어 |
| GPIO 22 | 터렛 모터 IN2 | DRV8833 터렛 제어 |
| GPIO 23 | 포신 서보 모터 | 포신 당기기 제어 (A 버튼) |
...
### 속도 조절
- **Y 버튼 + D-PAD 위**: 좌측 트랙 속도 배율 증가 (+0.02)
- **Y 버튼 + D-PAD 아래**: 좌측 트랙 속도 배율 감소 (-0.02)
- **X 버튼 + D-PAD 위**: 우측 트랙 속도 배율 증가 (+0.02)
- **X 버튼 + D-PAD 아래**: 우측 트랙 속도 배율 감소 (-0.02)
