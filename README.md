...
| ESP32 핀 | 연결 대상 | 설명 |
|----------|-----------|------|
| GPIO 2 | LED | 포 발사 시 깜빡임 |
| GPIO 4 | 헤드라이트 LED | 헤드라이트 제어 |
| GPIO 5 | 포신 서보 모터 | 포신 각도 제어 (우측 Y축) |
